      ...
      mCubeFace(CFACE_PX)
{
    ...
    else if (type >= DataMeshCube && type <= DataMeshCubePZ)
    {
        ...
        if (type != DataMeshCube)
        {
            ...
            if (type == DataMeshCubePX)
                mCubeFace = CFACE_PX;
            else if (type == DataMeshCubeNX)
                mCubeFace = CFACE_NX;
            else if (type == DataMeshCubePY)
                mCubeFace = CFACE_PY;
            else if (type == DataMeshCubeNY)
                mCubeFace = CFACE_NY;
            else if (type == DataMeshCubePZ)
                mCubeFace = CFACE_PZ;
            else if (type == DataMeshCubeNZ)
                mCubeFace = CFACE_NZ;
        }
    }
    else
